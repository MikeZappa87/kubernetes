...
func AddKubeletConfigFlags(mainfs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.StringVar(&c.NetworkRuntimeEndpoint, "network-runtime-endpoint", "unix:///tmp/kni.sock", "The endpoint of network runtime service. Unix Domain Sockets are supported on Linux. Examples:'unix:///path/to/runtime.sock'")
